# Ticino Software Craft talk

## Description

This is the [reference repository](https://github.com/NoriSte/frontend-testing-on-steroids-ticino-software-craft) with all the contents and the examples of the talk for [Ticino Software Craft](https://www.meetup.com/it-IT/Ticino-Software-Craft/).
